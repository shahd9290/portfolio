export const projectsData = [
  ...
  },
  {
    ...
    longDescription:
      "My very first project was a simple password manager that I had created for my A-Level Computer Sciene coursework. Built with Python and SQLite3, it allows users to store passwords to their system that are encrypted with a dedicated key, with a simple interface provided to facilitate ease of use. Interestingly this project was completed without the use of Object-Oriented Programming principles, which I have used in my more recent projects, and thus this project serves as a reminder for myself to keep track of how my programs evolve as I progress through my career.",
    grade: 62,
