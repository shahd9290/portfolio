...
import { Mail, Phone, MapPin, Github, Linkedin, ExternalLink, Code, Database, Globe, Calendar } from "lucide-react"
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Full-stack developer passionate about creating innovative web applications and teaching the next generation
            of programmers
          </p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 space-y-16">
        ...
        <section>
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            I'm a passionate software developer with expertise in full-stack web development and a strong background in
            teaching technology. I love building applications that solve real problems and sharing knowledge with
            others. My experience spans from creating enterprise-level backend systems to developing interactive web
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent>
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  <li>
                    Delivered Computer Science lessons covering Python Programming, Game Development, and Web
                    Technologies
                  </li>
                  <li>Managed day-to-day operations of tech camps ensuring safe and secure learning environments</li>
                  <li>Developed curriculum and teaching materials for various skill levels</li>
                  <li>Mentored students in software development best practices and problem-solving techniques</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-gray-600">Royal Holloway, University of London • Sep 2024 - Apr 2025</p>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Supporting lecturers in computer science lab sessions, helping students with programming assignments,
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="text-lg font-semibold">BSc Computer Science [Software Engineering]</h3>
